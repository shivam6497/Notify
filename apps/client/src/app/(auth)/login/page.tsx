  ...
  return (
    <AuthLayout>
      <div className="mb-8">
        ...
        <p className="text-[#525252] text-sm mt-1.5">Sign in to your account</p>
      </div>

      {/* google */}
      <button
        onClick={loginWithGoogle}
        className="w-full flex items-center justify-center gap-2.5 bg-[#141414] hover:bg-[#1a1a1a] border border-[#262626] hover:border-[#333] text-[#a3a3a3] hover:text-white text-sm rounded-lg px-4 py-2.5 transition-all duration-150 cursor-pointer"
      >
        ...
        <div>
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute tabIndex={-1} right-2.5 top-1/2 -translate-y-1/2 text-[#525252] hover:text-[#a3a3a3] transition-colors"
              tabIndex={-1}
            >
              {showPassword ? (
      ...
      <button
        onClick={() => mutate()}
        disabled={isPending}
        className="mt-4 w-full bg-white hover:bg-zinc-100 text-black text-sm font-medium rounded-lg px-4 py-2.5 transition-all duration-150 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
      >
